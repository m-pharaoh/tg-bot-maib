...
# async def get_chat_history(chat_history: list) -> str:
#     return await set_chat_history_for_llm(chat_history)
...
def main() -> None:
    ...
    application = Application.builder().token(token=constants.TOKEN).build()
    ...
    # email commands
    application.add_handler(CommandHandler("start_email_bot", init_email_agent))
    application.add_handler(CommandHandler("send_email", send_gmail_email))
    application.add_handler(CommandHandler("draft_email", draft_gmail_email))
    application.add_handler(CommandHandler("read_email", read_gmail_email))

    # on non command i.e message - echo the message on Telegram
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, bot_messenger))
